...
class MyFrame(wx.Frame):
    ...
    def ToolBar(self):
        ...
        tb.AddTool(10, "New", new_bmp)
        #tb.AddTool(10, "New", new_bmp, shortHelp="New", longHelp="Long help for 'New'")
        self.Bind(wx.EVT_TOOL, self.OnToolClick, id=10)
        self.Bind(wx.EVT_TOOL_RCLICKED, self.OnToolRClick, id=10)

        tb.AddTool(20, "Open", open_bmp)
        #tb.AddTool(20, open_bmp, "Open", "Long help for 'Open'")
        #tb.AddTool(20, "Open", open_bmp, shortHelp="Open", longHelp="Long help for 'Open'")
        self.Bind(wx.EVT_TOOL, self.OnToolClick, id=20)
        self.Bind(wx.EVT_TOOL_RCLICKED, self.OnToolRClick, id=20)

        tb.AddSeparator()
        tb.AddTool(20, "Copy", copy_bmp)
        #tb.AddTool(30, copy_bmp, "Copy", "Long help for 'Copy'")
        self.Bind(wx.EVT_TOOL, self.OnToolClick, id=30)
        self.Bind(wx.EVT_TOOL_RCLICKED, self.OnToolRClick, id=30)

        ##tb.AddTool(40, paste_bmp, "Paste", "Long help for 'Paste'")
        ...
        tool = tb.AddCheckTool(50, "Checkable", Tog1.GetBitmap(),
    ...
    def Populate(self, name, content='', file=''):
        if name in self.h.keys():
            html = self.h[name]
